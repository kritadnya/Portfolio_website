      ...
      <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-ovo'>
        ...
        <div className='grid grid-cols-auto gap-6 my-10 '>
            {serviceData.map(({icon,title,description,link},index)=>(
                <div key={index} className='border-[0.5px] border-gray-400 rounded-lg px-8 py-12 hover:shadow-black cursor-pointer hover:bg-light hover:-translate-y-1 duration-500'>
                    ...
                    <a href={link} className='flex items-center gap-2 text-sm mt-5' >
                        Project Link <Image src={assets.right_arrow} alt='' className='w-4'/>
                    </a>
